    ...
    ; p
        [%i18n
          Demo.internationalization_2
            ~f1:[code [txt "assets/myapp_i18n.tsv"]]
            ~f2:[code [txt "myapp_i18n.eliom"]]]
    ; p [txt [%i18n Demo.S.internationalization_3]]
    ; p
        [%i18n
          Demo.internationalization_4
            ~f:[code [txt "assets/myapp_Demo_i18n.tsv"]]
...
let%shared () =
  Myapp_base.App.register ~service:Demo_services.demo_i18n
    ( Myapp_page.Opt.connected_page @@ fun myid_o () () ->
      let%lwt p = page () in
      Myapp_container.page ~a:[a_class ["os-page-demo-i18n"]] myid_o p )
