...
let%shared page () =
  Lwt.return
    ...
    ; p
        [%i18n
          Demo.services_1
            ~f1:[code [txt "myapp_services.eliom"]]
            ~f2:[code [txt "myapp_handlers.eliom"]]
            ~f3:[code [txt "myapp.eliom"]]]
...
let%shared () =
  Myapp_base.App.register ~service:Demo_services.demo_links
    ( Myapp_page.Opt.connected_page @@ fun myid_o () () ->
      let%lwt p = page () in
      Myapp_container.page ~a:[a_class ["os-page-demo-links"]] myid_o p )
