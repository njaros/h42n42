...
let%shared () =
  Myapp_base.App.register ~service:Demo_services.demo_pagetransition
...
let%shared () =
  ...
  in
  Myapp_base.App.register ~service:Demo_services.detail_page
    (Myapp_page.Opt.connected_page detail_page_handler)
