  ...
  Lwt.return
    ...
    ; p
        [%i18n
          Demo.tips4
            ~set_page:
              [a ~service:Myapp_services.settings_service [%i18n Demo.tips5] ()]]
    ]
...
let%shared () =
  Myapp_base.App.register ~service:Demo_services.demo_tips
    ( Myapp_page.Opt.connected_page @@ fun myid_o () () ->
      let%lwt p = page () in
      Myapp_container.page ~a:[a_class ["os-page-demo-tips"]] myid_o p )
