...
let os_db_host = ref (Some (Sys.getenv "PGHOST"))
let os_db_port = ref (Some (int_of_string (Sys.getenv "PGPORT")))
let os_db_user = ref (Some (Sys.getenv "PGUSER"))
let os_db_password = ref (Some (Sys.getenv "PGPASSWORD"))
let os_db_database = ref (Some (Sys.getenv "PGDATABASE"))
