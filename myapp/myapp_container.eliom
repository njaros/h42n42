  ...
  Lwt.return
    (header
       ...
       [ a
           ...
           [txt Myapp_base.displayed_app_name]
           ()
       ; user_box ])
...
let%shared os_footer () =
  ...
  footer
    ...
    [ p
        ...
        ; a ~service:Myapp_services.os_github_service
            [txt " Ocsigen Start "]
            ()
        ; txt [%i18n S.footer_eliom_distillery]
        ; a ~service:Myapp_services.ocsigen_service [txt " Ocsigen "] ()
